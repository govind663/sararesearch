                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:670px;background:#fff; border-radius:3px; text-align:center; box-shadow:0 6px 18px rgba(0,0,0,.06);">
                                ...
                                <tr>
                                    <td style="text-align:center; padding:0 35px;">
                                        <img width="220px" height="100px" src="https://sararesearch.com/images/home/logo.webp" alt="SRDC Logo" title="SRDC Logo">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding:30px 35px;">
                                        ...
                                        <p style="color:#44474d; font-size:18px; line-height:24px; text-align:left;">
                                            <strong>First Name:</strong> {{ $data['f_name'] }}
                                        </p>
                                        <p style="color:#44474d; font-size:18px; line-height:24px; text-align:left;">
                                            <strong>Last Name:</strong> {{ $data['l_name'] }}
                                        </p>
                                        <p style="color:#44474d; font-size:18px; line-height:24px; text-align:left;">

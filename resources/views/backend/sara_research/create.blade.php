...
@section('title')
SARA & Development Center Pvt. Ltd. | Add About Sara
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Add About Sara</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body add-post">
                            <form method="POST" action="{{ route('sara-research.store') }}" class="form-horizontal" enctype="multipart/form-data">
                                @csrf

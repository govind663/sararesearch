...
@section('title')
SARA Research & Development Center Pvt. Ltd. | Add Banner
@endsection
                                ...
                                <div class="pd-20 card-box mb-30">
                                    ...
                                    <div class="form-group row mt-3 p-3">
                                        <table class="table table-bordered p-3" id="dynamicAmenitiesTable">
                                            ...
                                            <tbody>
                                                @if(old('title'))
                                                    @foreach(old('title') as $index => $value)
                                                        <tr>
                                                            <td>
                                                                <input type="text" id="title_{{ $index }}" name="title[]" class="form-control @error("title.$index") is-invalid @enderror" value="{{ $value }}">
                                                                @error("title.$index")
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>

...
@section('title')
SARA Research & Development Center Pvt. Ltd. | Add Our Advantage
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Add Our Advantage</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body add-post">
                            <form method="POST" action="{{ route('our-advantages.store') }}" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="pd-20 card-box mb-30">
                                    ...
                                    <div class="form-group row mt-3 p-3">
                                        <table class="table table-bordered p-3" id="dynamicAmenitiesTable">
                                            ...
                                            <tbody>
                                                @if(old('advantages_title'))
                                                    @foreach(old('advantages_title') as $index => $title)
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <textarea id="advantages_description_{{ $index }}" name="advantages_description[]" class="form-control @error("advantages_description.$index") is-invalid @enderror">{{ old("advantages_description.$index") }}</textarea>

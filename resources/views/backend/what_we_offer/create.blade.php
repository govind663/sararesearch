...
@section('title')
SARA Research & Development Center Pvt. Ltd. | Add What We Offer
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Add What We Offer</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body add-post">
                            <form method="POST" action="{{ route('what-we-offer.store') }}" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
